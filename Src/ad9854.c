...
#define AD9854_UDCLK0  HAL_GPIO_WritePin(GPIOE,GPIO_Pin_1, GPIO_PIN_RESET)//AD9854更新时钟
#define AD9854_UDCLK1  HAL_GPIO_WritePin(GPIOE,GPIO_Pin_1, GPIO_PIN_SET)//AD9854更新时钟
